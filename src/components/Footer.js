    ...
    <React.Fragment>
        ...
        <footer className="footer">
            <div className="footer-copyright text-center p-4">
                ...
                <span className="icon-span">
                    <a id = "resume" className = "icon" href={process.env.PUBLIC_URL + "/assets/Wu, Cynthia - Resume - 2020 .pdf"} target="_blank" rel="noreferrer"><span className="mr-2 far fa-file-pdf"></span></a>
                </span>
            </div>
        </footer>
